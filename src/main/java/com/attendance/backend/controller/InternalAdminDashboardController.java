...
@RestController
@RequestMapping("/api/internal/admin/dashboard")
public class InternalAdminDashboardController {
    ...
    public InternalAdminDashboardController(AdminService adminService, InternalApiProperties internalApiProperties) {
        this.adminService = adminService;
        this.internalApiProperties = internalApiProperties;
    }

    @GetMapping
    public ResponseEntity<InternalDashboardResponse> getDashboard(
        ...
        return ResponseEntity.ok(adminService.getTodayDashboardForAdmin(adminEmployeeCode, filter, workplaceId));
    }
